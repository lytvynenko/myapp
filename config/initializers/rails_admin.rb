...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Crush', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Crush', 'User']
  ...
  # config.model 'Crush' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your crush.rb model definition
